...
| settlementMethods     | bytes[]       | An array of supported settlement methods, including the specification of fiat currencies and prices, by which the maker is willing to send/receive payment |
...
Emitted when the settlement methods of an offer are changed
...
Edits the supported settlement methods of an open swap offer. This function can only be called by the maker of the offer in question.

| Name                  | Type    | Description                                                                                                     |
|:----------------------|:--------|:----------------------------------------------------------------------------------------------------------------|
| offerID               | bytes16 | The id of the offer to be edited                                                                                |
| editedOffer           | Offer   | An Offer struct with the new settlement methods of the open offer                                               |
